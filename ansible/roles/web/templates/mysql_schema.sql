...
CREATE TABLE `lab_computerlab` (
  ...
  `courseinstructor2` varchar(100) DEFAULT 'NA',
  `courseinstructor3` varchar(100) DEFAULT 'NA',
  `instructor2_id` varchar(20) DEFAULT 'NA',
  `instructor3_id` varchar(20) DEFAULT 'NA',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=17 DEFAULT CHARSET=latin1;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Table structure for table `lab_faculty`
--

DROP TABLE IF EXISTS `lab_faculty`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `lab_faculty` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `directory_id` varchar(30) NOT NULL,
  PRIMARY KEY (`id`)
...
--
-- Table structure for table `lab_sandbox`
--

DROP TABLE IF EXISTS `lab_sandbox`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `lab_sandbox` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `labname` varchar(100) NOT NULL,
  `labdescription` varchar(100) NOT NULL,
  `amazonami` varchar(100) NOT NULL,
  ...
  `lab_auth_info` varchar(100) NOT NULL,
  `instance_type` varchar(20) NOT NULL,
  `instance_type_desc` varchar(100) NOT NULL,
  `softwares` text,
  PRIMARY KEY (`id`)
